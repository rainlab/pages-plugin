...
/**
 * MenuPickerField content field stores a static menu reference selected
 * using the staticmenupicker form widget.
 *
 * @link https://docs.octobercms.com/3.x/extend/tailor-fields.html
 */
class MenuPickerField extends ContentFieldBase
{
    /**
