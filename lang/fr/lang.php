...
return [
    ...
    'menuitem' => [
        ...
        'allow_nested_items_comment' => 'Les sous-éléments peuvent être générés dynamiquement par les pages statiques et certains des autres types d\'élement',
        'url' => 'URL',
        'reference' => 'Réference',
        'title_required' => 'Le Titre est requis',
        'unknown_type' => 'Type d\'élement du menu inconnu',
        'unnamed' => 'Elément de menu sans nom',
        'add_item' => 'Ajouter un elément',
        'new_item' => 'Nouvel élément du menu',
        'replace' => 'Remplacer cet élément part ses sous-éléments générés',
        'replace_comment' => 'Utiliser cette case à cocher pour envoyer les sous-élements générés au même niveau que cet élément. Cet élément sera lui-même masqué.',
        'cms_page' => 'Page CMS',
        'cms_page_comment' => 'Sélectionnez une page à ouvrir lors d\'un clic sur cet élément du menu.',
        'reference_required' => 'La référence de l\'élement du menu est requis.',
    ...
    'snippet' => [
        ...
        'column_type_string' => 'Chaine de caractères',
