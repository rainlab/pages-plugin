...
return [
    ...
    'page'      => [
        ...
        'delete_confirmation'   => 'Ali ste prepričani, da želite izbrisati izbrane strani? S tem boste izbrisali tudi podstrani, če obstajajo.',
        'no_records'            => 'Ni najdenih strani.',
        'delete_confirm_single' => 'Ali ste prepričani, da želite izbrisati to stran? S tem boste izbrisali tudi podstrani, če obstajajo.',
        'new'                   => 'Nova stran',
        ...
        'url_not_unique'        => 'Ta URL uporablja že druga stran.',
        'layout'                => 'Postavitev',
    ...
    'menu'      => [
        ...
        'saved'                 => 'Meni je bil uspešno shranjen.',
        'name'                  => 'Ime',
        'code'                  => 'Koda',
        'items'                 => 'Elementi menija',
        'add_subitem'           => 'Dodaj pod-element',
        'code_required'         => 'Polje "Koda" je obvezno',
        'invalid_code'          => 'Neveljaven format za kodo. Koda lahko vsebuje številke, latinične črke in naslednje znake: _-',
    ],
    'menuitem'  => [
        'title'                      => 'Naslov',
        'editor_title'               => 'Uredi element menija',
        'type'                       => 'Vrsta',
        'allow_nested_items'         => 'Dovoli ugnezdene elemente',
        ...
        'title_required'             => 'Polje "Naslov" je obvezno',
        'unknown_type'               => 'Neznana vrsta elementa menija',
        'unnamed'                    => 'Neimenovan element menija',
        'add_item'                   => 'Dodaj <u>P</u>ostavko',
        'new_item'                   => 'Nov element menija',
        'replace'                    => 'Zamenjaj ta element z njegovimi pod-elementi',
        'replace_comment'            => 'Z uporabo tega kvadratka lahko potisnete ustvarjene elemente menija na enak nivo tega elementa. Ta element bo skrit.',
        'cms_page'                   => 'CMS stran',
        'cms_page_comment'           => 'Izberite stran, ki jo želite odpreti, ko kliknete element menija.',
        ...
        'display_tab'                => 'Prikaz',
        'hidden'                     => 'Skrito',
        'hidden_comment'             => 'Ta element menija skrij na spletni strani.',
        'attributes_tab'             => 'Atributi',
        'code'                       => 'Koda',
        'code_comment'               => 'Vnesite kodo za element menija, če do njega želite omogočiti API dostop.',
        ...
        'external_link_comment'      => 'Povezave za ta element menija odpiraj v novem oknu.',
    ...
    'object'    => [
        'invalid_type' => 'Neznana vrsta predmeta',
        'not_found'    => 'Zahtevanega predmeta ni mogoče najti.',
    ],
    'editor'    => [
        'title'                     => 'Naslov',
        ...
        'hidden'                    => 'Skrito',
        'hidden_comment'            => 'Skrite strani so dostopne samo prijavljenim administratorjem.',
        'navigation_hidden'         => 'Skrij v navigaciji',
        'navigation_hidden_comment' => 'Potrdite to polje, če želite skriti stran pred samodejno ustvarjenimi meniji in povezavami.',
    ],
    'snippet'   => [
        'partialtab'            => 'Gradniki',
        'code'                  => 'Koda gradnika',
        ...
        'not_found'             => 'Gradnika s kodo :code ni mogoče najti v temi.',
    ...
    'component' => [
        ...
        'static_page_use_content_description'  => 'Če ni označeno, se razdelek z vsebino ne bo prikazal pri urejanju statične strani. Vsebina strani bo določena izključno prek vsebinskih okvirov in spremenljivk.',
        ...
        'static_breadcrumbs_description'       => 'Ustari povezave za statično stran.',
