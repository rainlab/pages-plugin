...
The `childPages` component outputs a list of child pages of the current page. The default component partial outputs a simple nested unordered list:
...
`navigation_hidden` | `bool` | Whether the page is hidden in automatically generated contexts (i.e. menu)
