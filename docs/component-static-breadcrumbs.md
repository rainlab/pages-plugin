...
The `staticBreadcrumbs` component outputs a breadcrumb navigation for the current static page. This component does not have any properties. The default component partial outputs a simple unordered list for the breadcrumbs:
